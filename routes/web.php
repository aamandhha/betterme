...
Route::resource('habbit', HabbitsController::class, ['except' => ['index', 'destroy', 'save']]);
...
Route::post('{sessionUser}/habbit/save', [HabbitsController::class, 'save'])->name('habbits.save');
